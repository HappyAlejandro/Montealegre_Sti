...
import * as math from 'mathjs';
 ...
 class Algorit {
    ...
    @observable csvArchivo: string = '/data/respuestas.csv';
    ...
    @action csvFetch() {
        return fetch(this.csvArchivo).then(function (response: any) {
    ...
    @action csvFest() {
        ...
        this.festResults.push(festResults);
        console.log(toJS(festResults));
    }
...
const algorit = new Algorit();
export default algorit;